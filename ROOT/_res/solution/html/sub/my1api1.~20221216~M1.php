...
<div class="cp1api1use1 type2">
	<div class="di1">
		...
		<div class="dd1">
			...
			<span class="t2">2022.12.10 - 2022.12.11 ( 02일 )</span>
		</div>
	</div>
</div>
<!-- /cp1api1use1 -->
...
<div class="cp1use1chart1">
	...
	<script>/*<![CDATA[*/
		// 차트 기본값 전체 (이후 코드 적용). 20221211. @m.
			Chart.defaults.global.defaultFontColor = '#fff';
			Chart.defaults.global.defaultFontStyle = '600';
			Chart.defaults.global.defaultFontSize = 14;
			Chart.defaults.global.defaultFontFamily = "'Apple SD Gothic Neo', Roboto, Lato, 'Open Sans',OpenSans, 'Malgun Gothic', sans-serif";
			// 범례 차트 간격
...
<script>/*<![CDATA[*/
	$(function(){
		...
		/** ◇◆ 클릭한 사용 서비스를 레이어창 제목으로. 20221211. @m.
		 */
		$('[href="#layer1detail1"]').on('click', function(){
		 ...
		 */
		(function(){
			var $my = $('#layer1detail1.cp1layer1lightbox1'); // 레이어창
			// 닫기 클릭 기존 동작 제거하고 다시 만듦
			$('.close, [data-role="close"]', $my)
				.off('click')
				.on('click', function(e){
					console.log(111);
					e.preventDefault();
					$my.removeClass('on'); // 레이어창 활성 닫기
					// 레이어창 여닫기 링크 비활성하고 마지막 초첨 위치로 이동..
					$('[href="#layer1detail1"]').removeClass('on').filter('.opener-last').focus().removeClass('opener-last');
			});
		})();
