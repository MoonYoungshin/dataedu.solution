...
<title>한글발음화 (JS-Trans) - 활용 사례 | 데이터에듀 API</title>
	...
	<ul class="lst1">
		<li class="li1">
			<div class="w1">
				...
				<strong class="t2">영어 기초 교육</strong>
			</div>
			<div class="w2">
				<p class="t3">
					영어를 한글 발음 형태로 변환하여 영어 기초 발음 교육에 활용할 수 있습니다.
				</p>
			</div>
		</li>
		<li class="li1">
			<div class="w1">
				...
				<strong class="t2">교육용 콘텐츠</strong>
			</div>
			<div class="w2">
				<p class="t3">
					영어발음을 듣지 못하는 청각장애인 또는 청력이 저하된 사람들을 대상으로 교육용 콘텐츠를 제공할 수 있습니다.
				</p>
			</div>
		</li>
	</ul>
