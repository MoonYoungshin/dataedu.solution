...
<!-- 현재페이지 경로 + 사용자명 -->
<?php include $_SERVER['DOCUMENT_ROOT'].$sitePath."/html/sub/ocr1_body_head.php"; ?>
<!-- #body_content -->
<div id="body_content">
<!-- container -->
...
<!-- 본문제목 + 탭 -->
<?php include $_SERVER['DOCUMENT_ROOT'].$sitePath."/html/sub/ocr1_inc1.php"; ?>
<script>/*<![CDATA[*/
...
<div class="cp2text1input1">
	<div class="tg1">
		<p class="t1">
			아래는 예시 문장입니다. 문장을 직접 입력해주세요.
		</p>
	</div>
	<textarea rows="5" cols="80" class="textarea" maxlength="1000" placeholder="1000자 이내로 텍스트를 입력하세요." title=" 문장 입력">옛날 옛적에 마음씨 착한 나무꾼 돌쇠가 살고 있었어요. 돌쇠는 언제나 일찍 일어나 부모님께 드릴 아침을 준비하는 효자였어요.</textarea>
	<div class="tg2">
		<span class="textarea-count">
			<span class="t1"><!-- 70/1000 --></span><span class="t2">자</span>
		</span>
	</div>
	<div class="btns">
		<!-- <button type="submit" class="b1 button submit type1"><span class="t1">음성합성</span><i class="ic1"></i></button> -->
		<a href="tts1ing1compose1.php" class="b1 button submit type1"><span class="t1">음성합성</span><i class="ic1"></i></a>
	</div>
</div>
<!-- /cp2text1input1 -->

<script>/*<![CDATA[*/
	/** ◇◆ 최대 몇자 이내로 입력 가능. 20221102. @m.
	 * 입력 있으면 전송 활성
	 */
	(function(){
