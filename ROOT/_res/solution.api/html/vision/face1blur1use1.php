...
<title>얼굴 모자이크 (JS-Face Blur) - 활용 사례 | 데이터에듀 API</title>
	...
	<ul class="lst1">
		<li class="li1">
			<div class="w1">
				...
				<strong class="t2">로드뷰</strong>
			</div>
			<div class="w2">
				<p class="t3">
					길찾기 서비스로 실제 차량이 전국의 도로를 다니면서 촬영한 사진 속 사람들의 얼굴을 인식하여 블러처리를 하는데 활용할 수 있습니다.
				</p>
			</div>
		</li>
		<li class="li1">
			...
			<div class="w2">
				<p class="t3">
					뉴스나 기사에 사용될 보도자료에 찍힌 일반인들의 얼굴을 인식하여 블러처리를 할 수 있습니다.
				</p>
			</div>
		</li>
	</ul>
