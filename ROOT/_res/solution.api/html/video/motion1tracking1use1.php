...
<title>트래킹 (JS-Tracking) - 활용 사례 | 데이터에듀 API</title>
	...
	<ul class="lst1">
		<li class="li1">
			<div class="w1">
				...
				<strong class="t2">이상행동 식별</strong>
			</div>
			<div class="w2">
				<p class="t3">
					특정 인물의 이상행동을 감지하기 위해 활용할 수 있습니다.
				</p>
			</div>
		</li>
		<li class="li1">
			<div class="w1">
				...
				<strong class="t2">응급 시스템</strong>
			</div>
			<div class="w2">
				<p class="t3">
					기존 행동과 다른 위험 상황 발생 전에 선제적으로 대응할 수 있는 시스템 개발에 활용할 수 있습니다.
				</p>
			</div>
		</li>
	</ul>
