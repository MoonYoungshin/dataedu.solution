...
<script>/*<![CDATA[*/
	$(function(){
		...
		(function(){
			...
			// 진행바 클릭 ))@개발자. ☆★ 이거 참고해서 수집 완료되면 endProgress(); 호출하게 수정 필요!
			...
			function doProgress(msec){
				...
				// 카운팅 0~100%
				count = $({rate: 0}).animate({rate: 100},{
					duration: time,
					easing: 'linear',
					progress: function(){ // [CR] 초당 12번 실행
						var now = this.rate;
